 ...
 *
 * Copyright notice:
 * Copyright (c) 1996-2014 3Dconnexion. All rights reserved. 
 * 
...
static char incFileNameCvsId[]="(C) 1996-2014 3Dconnexion: $Id: si.h 10611 2014-07-24 14:12:06Z ngomes $";
...
typedef struct
{
  char appCmdID[SI_MAXAPPCMDID];	  /* The AppCmdID from the AppCommand ButtonAction */
} SiAppCmdID;
...
{
  SPWbool pressed;			/* SPW_TRUE if the invoking button pressed, SPW_FALSE otherwise */
  SPWuint32 functionNumber; /* The V3DCMD_ function number  *
                             * invoked by the user in a SI_CMD_EVENT     */
} SiCmdEventData;
